...
describe('useSendTransaction', function () {
    ...
    it('success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var spenderBalance, receiverBalance, _a, result, waitForCurrent, _b, _c, _d, _e;
        var _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, spender.getBalance()];
                case 1:
                    spenderBalance = _g.sent();
                    return [4 /*yield*/, receiver.getBalance()];
                case 2:
                    receiverBalance = _g.sent();
                    return [4 /*yield*/, src_1.renderWeb3Hook(core_1.useSendTransaction, { mockProvider: mockProvider })];
                case 3:
                    _a = _g.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
                    _c = (_b = result.current).sendTransaction;
                    _f = {};
                    return [4 /*yield*/, receiver.getAddress()];
                case 4: return [4 /*yield*/, _c.apply(_b, [(_f.to = _g.sent(), _f.value = ethers_1.BigNumber.from(10), _f)])];
                case 5:
                    _g.sent();
                ...
                case 6:
                    ...
                    return [4 /*yield*/, receiver.getBalance()];
                case 7:
                    _d.apply(void 0, [_g.sent()]).to.eq(receiverBalance.add(10));
                    _e = chai_1.expect;
                    return [4 /*yield*/, spender.getBalance()];
                case 8:
                    _e.apply(void 0, [_g.sent()]).to.not.eq(spenderBalance);
                    return [2 /*return*/];
            }
        });
    }); });
    it('sends with different signer', function () { return __awaiter(void 0, void 0, void 0, function () {
        var receiverBalance, secondReceiverBalance, _a, result, waitForCurrent, _b, _c, _d, _e;
        var _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    ...
                    _c = (_b = result.current).sendTransaction;
                    _f = {};
                    return [4 /*yield*/, secondReceiver.getAddress()];
                case 4: return [4 /*yield*/, _c.apply(_b, [(_f.to = _g.sent(), _f.value = ethers_1.BigNumber.from(10), _f)])];
                case 5:
                    _g.sent();
                    return [4 /*yield*/, waitForCurrent(function (val) { return val.state != undefined; })];
                case 6:
                    ...
                    return [4 /*yield*/, secondReceiver.getBalance()];
                case 7:
                    _d.apply(void 0, [_g.sent()]).to.eq(secondReceiverBalance.add(10));
                    _e = chai_1.expect;
                    return [4 /*yield*/, receiver.getBalance()];
                case 8:
                    _e.apply(void 0, [_g.sent()]).to.not.eq(receiverBalance);
                    return [2 /*return*/];
            }
        });
    }); });
